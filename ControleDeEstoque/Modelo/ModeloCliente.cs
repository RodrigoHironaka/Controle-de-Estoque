...
namespace Modelo
{
    ...
    public class ModeloCliente //clitipo 0->Pessoa Fisica 1-> Pessoa Juridica
    {
        ...
        public ModeloCliente(int clicod, String nome, String cpfcnpj, String rgie, String rsocial, 
